...
void ui_ScreenGame_screen_init(void)
{
    ...
    ui_ImageBoard = lv_img_create(ui_ScreenGame);
    lv_img_set_src(ui_ImageBoard, &ui_img_board_png);
    lv_obj_set_width(ui_ImageBoard, LV_SIZE_CONTENT);   /// 1
    lv_obj_set_height(ui_ImageBoard, LV_SIZE_CONTENT);    /// 1
    lv_obj_set_align(ui_ImageBoard, LV_ALIGN_CENTER);
    lv_obj_add_flag(ui_ImageBoard, LV_OBJ_FLAG_ADV_HITTEST);     /// Flags
    lv_obj_clear_flag(ui_ImageBoard, LV_OBJ_FLAG_SCROLLABLE);      /// Flags

    ui_BoardContainer = lv_obj_create(ui_ImageBoard);
    lv_obj_set_width(ui_BoardContainer, 440);
    lv_obj_set_height(ui_BoardContainer, 440);
    lv_obj_set_x(ui_BoardContainer, 0);
    lv_obj_set_y(ui_BoardContainer, -1);
